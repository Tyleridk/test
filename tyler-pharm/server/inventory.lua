...
RegisterNetEvent('crp-pharm:server:addgiftboxitems', function(source)
    local src = source
...
RegisterNetEvent('crp-pharm:RemoveItem', function(item, amount)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('crp-pharm:server:creategiftbox', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('crp-pharm:server:makingjoint', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    Player.Functions.RemoveItem('streetweed', 1)
    Player.Functions.RemoveItem(Config.BottleItem, 1)
    Player.Functions.AddItem('joint', 1)
end)

RegisterNetEvent('crp-pharm:server:makingbong', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('crp-pharm:server:makingdreamjoint', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('crp-pharm:server:makinghazyjoint', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('crp-pharm:server:makingcrushjoint', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('crp-pharm:server:makingbloomerjoint', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('crp-pharm:server:makingbrownie', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    Player.Functions.RemoveItem('brownie-mix', 1)
    Player.Functions.RemoveItem('streetweed', 1)
    Player.Functions.AddItem('weed-brownie', Config.CrimScriptPad)
end)

RegisterNetEvent('crp-pharm:server:makingweeddrink', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    Player.Functions.RemoveItem('drink-mix', 1)
    Player.Functions.RemoveItem('streetweed', 1)
    Player.Functions.RemoveItem('aluminumcan', 1)
    Player.Functions.AddItem('weed-drink', Config.DoctorScriptPad)
end)

RegisterNetEvent('crp-pharm:server:FinishJoint', function(taken, given)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('crp-pharm:server:GrindWeed', function(taken, given)
...
RegisterNetEvent('crp-pharm:server:MakePillBase', function(itemtype)
    local item = itemtype
    local amount = Config.supplyadd
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    Player.Functions.RemoveItem('PillBase', 1)
